...
sub main(@) {
    ...
    #
    if (!GetOptions('version|v'                 => \$number_of_files,
    ...
    my $description             = "automatic detected";
    ...
    while (<STDIN>)
    {
        ...
        {
            logit("in line 279: unused data $_");
        }
...
#EOF
            ...
            $lines ++;
            print $tmp_fh "$customerid;$uuid;$fastnetmoninstanceid;$administratorid;$blocktime;$dst;$src;$protocol;$sport;$dport;$dport;$icmp_type;$icmp_code;$flags;$length;$ttl;$dscp;$frag;$mode;$description\n";
        }
